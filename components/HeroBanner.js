...
const HeroBanner = () => {
  return (
    <div>
        ...
        <h1 className='text-black text-[3.5rem] font-bold mb-6'>Unleash Your <span className='text-[#F0A305]'>creativity</span> and Make Your Mark on the <span className='text-[#F0A305]'>World</span></h1>
