...
const MainNav = () => {
  ...
  return (
    ...
    <main>
    <div class="bg-white   fixed top-0 left-0 right-0 shadow-lg ">
...
dkf
    ...
    <div className='gap-6 flex items-center '>
      <BsSearch />
      <BsCart />
    <button className='border    rounded-md px-6 py-2 text-bold '>login</button>
      <button className='border    rounded-md bg-blue-800 text-white px-6 py-2 text-bold '>Sign up</button>
    </div>
      ...
      <div className={nav? 'fixed top-0 bg-white z px-4 left-0 w-[60%]  border-r h-full  border-r-gray-600 ease-out duration-700' :'fixed left-[-100%]   duration-1000' }>
     ...
     k
        ...
        <li className='p-3 cursor-pointer'cur>about</li>
        <li className='p-3 cursor-pointer'> songs</li>
        <li className='p-3 cursor-pointer'> services</li>
        </ul>
        <button className='border-dashed border-4 '>book a session </button>
      </div>
